...
Gestion du sprite Waveman dans la page accueil
*/

class waveman_accueil {
    constructor(){
        this.CANVAS_HEIGHT = 175
        this.CANVAS_WIDTH = 175
        this.POSITION_INI_X = 125
        this.POSITION_INI_Y = 50

        // Création de la balise canvas pour waveman
        this.element = document.createElement('canvas')
        this.element.setAttribute("id", "waveman")
		...
		this.scale = 3;
        this.tiledImage = new TiledImage( "img/waveman.png", this.columnCount, this.rowCount,
