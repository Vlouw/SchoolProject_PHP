...
Projet - Web3
Henri-Paul Bolduc
crystalman_accueil.js

Gestion du sprite crystalman dans la page accueil
*/

class crystalman_accueil {
    constructor(){
        this.CANVAS_HEIGHT = 175
        this.CANVAS_WIDTH = 175
        this.POSITION_INI_X = 975
        this.POSITION_INI_Y = 65

        // Création de la balise canvas pour crystalman
        this.element = document.createElement('canvas')
        this.element.setAttribute("id", "crystalman")
		...
		this.scale = 3;
        this.tiledImage = new TiledImage( "img/crystalman.png", this.columnCount, this.rowCount,
