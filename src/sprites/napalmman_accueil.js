...
Projet - Web3
Henri-Paul Bolduc
napalmman_accueil.js

Gestion du sprite napalmman dans la page accueil
*/

class napalmman_accueil {
    constructor(){
        this.CANVAS_HEIGHT = 175
        this.CANVAS_WIDTH = 175
        this.POSITION_INI_X = 125
        this.POSITION_INI_Y = 400

        // Création de la balise canvas pour napalmman
        this.element = document.createElement('canvas')
        this.element.setAttribute("id", "napalmman")
		...
		this.scale = 3;
        this.tiledImage = new TiledImage( "img/napalmman.png", this.columnCount, this.rowCount,
